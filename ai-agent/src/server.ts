...
const GPU_PROVIDERS = [
    ...
    {
        id: "a6000-node-1",
        name: "RTX A6000 Studio",
        model: "RTX A6000 48GB",
        count: 4,
        location: "Europe (Amsterdam)",
        locationCode: "eu-west-1",
        basePrice: 0.55,
        vram: "48GB",
        ram: "256GB",
        storage: "4TB NVMe",
    ...
    {
        id: "a10g-node-1",
        name: "A10G Inference Node",
        model: "A10G 24GB",
        count: 8,
        location: "Asia-Pacific (Tokyo)",
        locationCode: "ap-northeast-1",
        basePrice: 0.35,
        vram: "24GB",
        ram: "192GB",
        storage: "2TB NVMe",
